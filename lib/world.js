...
function World(width, height) {
  this.width = width;
  this.height = height;
  this.snake = new Snake(200, 200, 20, 20, 'right');
  this.newFood();
...
World.prototype.changeLevel = function() {
  if (this.score % 100 === 0) {
  this.level ++;
  document.getElementById('user-level').innerHTML = "<p>level: " + this.level + "</p>";
  }
};

// World.prototype.startPlay = function() {
//   this.play = true;
// };
//
// World.prototype.EndPlay = function() {
//   this.play = false;
// };
